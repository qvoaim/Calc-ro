 ...
 */ var Prism = (function (l) {
    var d = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
        ...
        i = {
            ...
            util: {
                encode: function a(e) {
                    return e instanceof F
                        ? new F(e.type, a(e.content), e.alias)
                        : Array.isArray(e)
                            ? e.map(a)
                            : e
                                .replace(/&/g, "&amp;")
                ...
                objId: function (a) {
                    return (
                        a.__id || Object.defineProperty(a, "__id", { value: ++y }),
                        a.__id
                    );
                },
                clone: function a(e, t) {
                    ...
                    switch (i.util.type(e)) {
                        case "Object":
                            ...
                            ((n = {}), (t[r] = n));
                            for (var u in e) e.hasOwnProperty(u) && (n[u] = a(e[u], t));
                            return n;
                        case "Array":
                            return (
                                (r = i.util.objId(e)),
                ...
                setLanguage: function (a, e) {
                    ((a.className = a.className.replace(RegExp(d, "gi"), "")),
                    ...
                    for (var o in e)
                        if (e.hasOwnProperty(o)) {
                            ...
                            c === "Object" && !r[u(s)]
                                ...
                                : c === "Array" && !r[u(s)] && ((r[u(s)] = !0), a(s, t, o, r));
                        }
                },
            },
            plugins: {},
            ...
            highlightAllUnder: function (a, e, t) {
                ...
                for (var r = 0, u; (u = n.elements[r++]);)
                    i.highlightElement(u, e === !0, n.callback);
            },
            highlightElement: function (a, e, t) {
                ...
                u && u.nodeName.toLowerCase() === "pre" && i.util.setLanguage(u, n);
                var o = a.textContent,
                    s = { element: a, language: n, grammar: r, code: o };
                function c(x) {
                    ((s.highlightedCode = x),
                ...
                if (
                    ...
                    (i.hooks.run("complete", s), t && t.call(s.element));
                    return;
                }
                if ((i.hooks.run("before-highlight", s), !s.grammar)) {
                    c(i.util.encode(s.code));
                    return;
                }
                if (e && l.Worker) {
            ...
            highlight: function (a, e, t) {
                ...
                return (
                    ...
                    F.stringify(i.util.encode(n.tokens), n.language)
                );
            },
            tokenize: function (a, e) {
                ...
                var r = new E();
                return (k(r, r.head, a), T(a, r, e, r.head, 0), C(r));
            },
            hooks: {
                all: {},
                add: function (a, e) {
    ...
    F.stringify = function a(e, t) {
        ...
        (u &&
            (Array.isArray(u)
                ? Array.prototype.push.apply(r.classes, u)
                : r.classes.push(u)),
            i.hooks.run("wrap", r));
        var o = "";
        for (var s in r.attributes)
            o +=
                " " + s + '="' + (r.attributes[s] || "").replace(/"/g, "&quot;") + '"';
        return (
            "<" +
            r.tag +
            ' class="' +
                    ...
                    for (
                        ...
                        if (!($ instanceof F)) {
                            var z = 1,
                                m;
                            if (H) {
                                if (((m = S(P, A, a, Z)), !m || m.index >= a.length)) break;
                                var L = m.index,
                                    U = m.index + m[0].length,
                                    w = A;
                                for (w += v.value.length; L >= w;)
                                    ((v = v.next), (w += v.value.length));
                                if (((w -= v.value.length), (A = w), v.value instanceof F))
                                    continue;
                                for (
                                    var _ = v;
                                    _ !== e.tail && (w < U || typeof _.value == "string");
                                    _ = _.next
                                )
                                    (z++, (w += _.value.length));
                                (z--, ($ = a.slice(A, w)), (m.index -= A));
                            } else if (((m = S(P, 0, $, Z)), !m)) continue;
                            var L = m.index,
                                I = m[0],
                                j = $.slice(0, L),
                                q = $.slice(L + I.length),
                            ...
                            var D = v.prev;
                            (j && ((D = k(e, D, j)), (A += j.length)), M(e, D, z));
                            var W = new F(o, x ? i.tokenize(I, x) : I, G, I);
                            if (((v = k(e, D, W)), q && k(e, v, q), z > 1)) {
                                var R = { cause: o + "," + c, reach: O };
                                (T(a, e, t, v.prev, A, R),
                                    u && R.reach > u.reach && (u.reach = R.reach));
                            }
                        }
                    }
                }
                ...
                l.addEventListener(
                    ...
                    function (a) {
                        var e = JSON.parse(a.data),
                            ...
                            n = e.code,
                            r = e.immediateClose;
                        (l.postMessage(i.highlight(n, i.languages[t], t)),
                            r && l.close());
                    },
                    !1,
                )),
    ...
    p && ((i.filename = p.src), p.hasAttribute("data-manual") && (i.manual = !0));
    function g() {
...
(typeof module < "u" && module.exports && (module.exports = Prism),
    ...
    Prism.hooks.add("wrap", function (l) {
        l.type === "entity" &&
            (l.attributes.title = l.content.replace(/&amp;/, "&"));
    }),
    Object.defineProperty(Prism.languages.markup.tag, "addInlined", {
        value: function (d, y) {
            ...
            ((b["language-" + y] = {
                pattern: /(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i,
                lookbehind: !0,
                inside: Prism.languages[y],
            }),
                (b.cdata = /^<!\[CDATA\[|\]\]>$/i));
            var i = {
                "included-cdata": { pattern: /<!\[CDATA\[[\s\S]*?\]\]>/i, inside: b },
            };
            i["language-" + y] = { pattern: /[\s\S]+/, inside: Prism.languages[y] };
            var F = {};
            ((F[d] = {
                pattern: RegExp(
    ...
    (function () {
        ...
        var l = "Loading\u2026",
            ...
            y = "\u2716 Error: File does not exist or is empty",
            b = {
                js: "javascript",
                py: "python",
                rb: "ruby",
        ...
        function M(p) {
            ...
            if (g) {
                var f = Number(g[1]),
                    a = g[2],
                    e = g[3];
                return a ? (e ? [f, Number(e)] : [f, void 0]) : [f, f];
            }
        }
                ...
                if (g.matches(E)) {
                    ...
                    (n && n.loadLanguages(e),
                        k(
                            ...
                            function (r) {
                                g.setAttribute(i, S);
                                var u = M(g.getAttribute("data-range"));
                                if (u) {
                                    var o = r.split(/\r\n?|\n/g),
                                        s = u[0],
                                        c = u[1] == null ? o.length : u[1];
                                    (s < 0 && (s += o.length),
...
`)),
                                        ...
                                        g.setAttribute("data-start", String(s + 1)));
                                }
                                ((f.textContent = r), Prism.highlightElement(f));
                            },
                            function (r) {
                                (g.setAttribute(i, T), (f.textContent = r));
                            },
                        ));
                }
            }),
            (Prism.plugins.fileHighlight = {
                highlight: function (g) {
                    for (
                        var f = (g || document).querySelectorAll(E), a = 0, e;
                        (e = f[a++]);
